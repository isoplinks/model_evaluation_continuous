...
gof_ppred <- read.csv("gof_ppred_pwres.csv")
...
#ModelName="All"
basiggofplot1 <- function (gofdata=gof_ppred,ModelName="All", ...)
{
  # gofdata<- gof
  # ModelName="All"
  ModelName=ModelName
...
basiggofplot2 <- function (gofdata=gof_ppred,ModelName="All", ...)
{
...
basiggofplot3 <- function (gofdata=gof_ppred,ModelName="All",logx=FALSE, ...)
{
...
npdeplot2 <- function (npdepredx=npdepredx,ModelName="All", logx=FALSE,...)
{
  ...
  npdepredplotobj<-  ggplot(npdepredxplot ,aes(x=Time,y=median))+
    geom_ribbon(aes(ymin=CIlower,ymax=CIupper,fill=PI,col=PI),alpha=0.1,col=NA)+
    geom_point(data=obsnpde,aes(x=PPRED,y= y),shape=1,color="blue",inherit.aes = FALSE)+
...
ggsave("./Figure_7A.tiff",Fig7A,compression="lzw",width=10,height=7,dpi=300)
...
ggsave("./Figure_7D.tiff",Fig7D,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_7B.tiff",Fig7B,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_4A.tiff",Fig4A,compression="lzw",width=10,height=7,dpi=300)
...
ggsave("./Figure_4D.tiff",Fig4D,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_4B.tiff",Fig4B,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_5A.tiff",Fig5A,compression="lzw",width=10,height=7,dpi=300)
...
ggsave("./Figure_5D.tiff",Fig5D,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_5B.tiff",Fig5B,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_6A.tiff",Fig6A,compression="lzw",width=10,height=7,dpi=300)
...
ggsave("./Figure_6D.tiff",Fig6D,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_6B.tiff",Fig6B,compression="lzw",width=10,height=3.5,dpi=300)
...
ggsave("./Figure_S12.tiff",NPCPLOT,compression="lzw",width=12.5,height=3.5,dpi=300)

tiff("./Figure_7C.tiff",width=16,height=11,unit="cm",res=300)
...
tiff("./Figure_4C.tiff",width=16,height=11,unit="cm",res=300)
...
tiff("./Figure_5C.tiff",width=16,height=11,unit="cm",res=300)
...
tiff("./Figure_6C.tiff",width=16,height=11,unit="cm",res=300)
